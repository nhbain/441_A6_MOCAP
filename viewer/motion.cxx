...
void Motion::SetBoneRotation(int nFrameNum, mocapvector vRot, int nBone)
{
	m_pPostures[nFrameNum].bone_rotation[nBone] = vRot;
}

void Motion::SetRootPos(int nFrameNum, mocapvector vPos)
{
...
int Motion::readAMCfile(char* name, float scale)
{
	...
	//Allocate memory for state mocapvector
	m_pPostures = new Posture [m_NumFrames]; 
