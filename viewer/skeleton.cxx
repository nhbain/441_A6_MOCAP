...
void Skeleton::readASFfile(char* asf_filename, float scale)
{
	...
	{		
		...
		while(1)
		{
			...
			//this line describes the bone's direction mocapvector in global coordinate
...
/***************************************************************************************
  ...
  matrix and translation mocapvector in the local coordinate of parent body 
*****************************************************************************************/
...
// loop through all bones to calculate local coordinate's direction mocapvector and relative orientation  
...
/*
	Transform the direction mocapvector (dir), 
...
void Skeleton::RotateBoneDirToLocalCoordSystem()
{
	...
	{
		//Transform dir mocapvector into local coordinate system
...
//	m_NumDOFs=6;
	...
	//transform the direction mocapvector for each bone from the world coordinate system 
