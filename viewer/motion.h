/*
	  ...
	  1. read an AMC file and store it in a sequence of state mocapvector 
	  2. write an AMC file
...
class Motion 
{
    ...
    public:
	   ...
	   void SetBoneRotation(int nFrameNum, mocapvector vRot, int nBone);
	   void SetRootPos(int nFrameNum, mocapvector vPos);
