...
struct Bone {
	...
	float dir[3];				// Unit mocapvector describes the direction from local origin to 
...
class Skeleton {
  ...
  private:
	...
	//Rotate all bone's direction mocapvector (dir) from global to local coordinate system
