...
/* Transform the point (x,y,z) by the matrix m, which is
   ...
   this is just a matrix-mocapvector multiply 
*/
...
/*
	Rotate mocapvector v by a, b, c in X,Y,Z order.
...
void vector_rotationXYZ(float *v, float a, float b, float c)
{
	...
	//Matrix mocapvector multiplication to generate the output mocapvector v.
...
//get the angle from mocapvector v1 to mocapvector v2 around the axis
